...
export default function AboutPage(){
    ...
    return(
		...
		<div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
			<Image
            width={48}
            height={48} src="/tsn_blog/public/mypic.jpeg" alt="" className="self-center flex-shrink-0 w-24 h-24 border rounded-full md:justify-self-start dark:bg-gray-500 dark:border-gray-700" />
			<div className="flex flex-col">
				<h4 className="text-lg font-semibold">Taric Ov</h4>
